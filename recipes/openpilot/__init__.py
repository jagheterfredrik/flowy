...
from pythonforandroid.recipe import IncludedFilesBehaviour, PyProjectRecipe
...
class OpenPilotRecipe(IncludedFilesBehaviour, PyProjectRecipe):
    src_filename = "../../../openpilot"
